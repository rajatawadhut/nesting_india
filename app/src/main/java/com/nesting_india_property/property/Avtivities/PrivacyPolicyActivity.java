...
public class PrivacyPolicyActivity extends AppCompatActivity {
    ...
    String privacy = "<p>\n" +
            ...
            "\t\t<br><br>\n" +
            "\t\twww.NestingIndia.com advises its User to exercise complete caution while completing online transactions and it is the sole responsibility of the User to verify and validate the information present on the site as well as the people whom they choose to interact with. RealEstateIndia.com shall not be responsible for any loss / damage due to negligence of the User. You have sole authority to access and update all the information posted by you on the Site and it is your responsibility to keep the same updated. It is strictly advised that Users respect the Privacy of other Users as well as keep their profiles updated. Access to services of the Site including updation / deletion of profile may be restricted / denied if it comes to the notice of www.NestingIndia.com that this would violate anybody else's rights or if so requested by a legal entity.\n" +
            "\t\t<h3>LIMITATION OF LIABILITY</h3>\n" +
            "\t\t<ul style=\"margin-left:30px;\">\n" +
            "\t\t<li>www.NestingIndia.com only offers a platform to showcase the property / project listings and has no role in any transaction or communications and hence shall not be liable for any loss or damage of any sort arising out of the use and/or temporary or permanent discontinuation of its services. Notwithstanding anything to the contrary contained herein, www.NestingIndia.com, liability to you for any cause whatsoever, and regardless of the form of the action, will at all times be limited to the amount paid, if any, by you to RealEstateIndia.com, for the Service during the term of membership.</li>\n" +
            "\t\t<li>www.NestingIndia.com being a public site with free access assumes no liability for the quality and genuineness of responses. RealEstate cannot monitor the responses received by any User in response to the information posted by them and so displayed on the site. User should conduct its own background checks on the bonafide nature of all response(s). www.NestingIndia.com will not be liable for any inaccuracy of information on this website.</li>\n" +
            ...
            "\t\t<h3>Refund / Money Back Policy:</h3>\n" +
            ...
            "\t\t<h3>Refund on the basis of fraudulent transactions</h3>\n" +
            ...
            "\t\t<h3>Refund on the basis of change in preference / delay in process</h3>\n" +
            ...
            "\t\t<h3>SUSPENSION / TERMINATION OF SERVICES</h3>\n" +
            ...
            "\t\t<h3>MATTER OF DISPUTES AND JURISDICTIONAL ASPECTS</h3>\n" +
